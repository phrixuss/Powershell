...
install-script get-windowsautopilot
...
if ($callswitch_install){
Add-AzTableRow -table $table -partitionKey $partitionKey -rowKey ([guid]::NewGuid().tostring()) -property @{"Computername"=$serialnumber;"Callswitch"="installed";"CallswitchVersion"=$callswitch_install.Version;"UserLoggedin"=$userloggedin}
}else{
Add-AzTableRow -table $table -partitionKey $partitionKey -rowKey ([guid]::NewGuid().tostring()) -property @{"Computername"=$serialnumber;"Callswitch"="not installed";"CallswitchVersion"="";"UserLoggedin"=$userloggedin}
