...
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'SlideshowDuration'; 'Type' = 'Dword'; 'Value' = '100000'; 'Path' = 'Software\Microsoft\Windows\CurrentVersion\Lock Screen'}
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'SlideshowDirectoryPath1'; 'Type' = 'ExpandString'; 'Value' = ''; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\Lock Screen'}
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'RotatingLockScreenOverlayEnabled'; 'Type' = 'Dword'; 'Value' = '00000000'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager'}
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'RotatingLockScreenEnabled'; 'Type' = 'Dword'; 'Value' = '00000000'; 'Path' = 'SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager'}