...
New-Item -Path "C:\Users\Public\Pictures\" -Name "Steer" -ItemType "Directory" -ErrorAction SilentlyContinue
    $WebClient = New-Object System.Net.WebClient
    $WebClient.DownloadFile("https://firstftorage01.blob.core.windows.net/steer/Steer%20Screensaver-1920x1200.png","C:\Users\Public\Pictures\Steer\support.jpg")
    ...
    $StatusValue = "1"
    $LockScreenImageValue = "C:\Users\Public\Pictures\steer\support.jpg"  #Change as per your needs
...
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'WallPaper'; 'Type' = 'string'; 'Value' = $($LockScreenImageValue); 'Path' = 'Control Panel\Desktop'}
